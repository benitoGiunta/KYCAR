---
name: rev-D3
description: Revue 2.5 du lot D3 (SyntheticDataProvider 100k, distributions, outliers injectés + vérité terrain, déterminisme, tailles EX-NFR-1/3). Opus/high : preuves statistiques et de déterminisme.
model: opus
effort: high
