---
name: fix-app
description: Remédiation 2.6 sur src/app, src/app.tsx, src/main.tsx, src/persistence, src/orchestration (intégration, parcours, persistance, O17 câblage élagage). Opus/high : effets transverses, concurrence inter-onglets.
model: opus
effort: high
