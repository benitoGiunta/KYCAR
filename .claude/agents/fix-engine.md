---
name: fix-engine
description: Remédiation 2.6 sur src/engine, src/worker, src/types (moteur, invariants, quantiles, M1/M2, validation, codec hash). Opus/high : corrections algorithmiques à prouver par banc.
model: opus
effort: high
