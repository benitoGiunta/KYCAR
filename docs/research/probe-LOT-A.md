...
| **A3** Couverture champs | **40 / 40** champs présents dans `listings[].details` ; **utiles KYCAR : 22 / 40** après retrait des 5 champs vendeur exclus par R3/RGPD et des 13 champs de formatage redondants (`.formatted` doublant `.raw`) | prouvé — arborescence exhaustive § T2.2 |
